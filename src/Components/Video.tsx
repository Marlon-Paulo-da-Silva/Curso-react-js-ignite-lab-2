          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/Marlon-Paulo-da-Silva.png"
                alt=""
              />

              <div>
                <strong className="font-bold text-2xl block">Marlon Paulo</strong>
                <span className="text-gray-200 text-sm block">CTO @RucriTechnology</span>
              </div>
            </div>
          </div>
